        ...
        <div className='custom_container flex flex-col sm:flex-row items-center gap-6 py-5'>
            <div className='flex flex-col gap-4'>
                <div className='flex flex-col gap-2'>
                    <p className='h3'>Leading Manpower Recruitment Agency of Pakistan</p>
                    <p className='h1'>Simplify Global<br />Talent Management:</p>
                    <p className='h1 text-primary'>Expert HR Export<br />Services</p>
