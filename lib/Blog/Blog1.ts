...
const blog = {
    _id:'01',
    title: "Expanding Horizons: The Scope of Overseas Employment for Pakistanis",
            ...
            list: [
                {
                    ...
                    text: "Language proficiency can be a significant hurdle to securing certain overseas jobs. Investing in language learning can significantly enhance job prospects."
                },
                {
                    heading: "Immigration Requirements:",
                    text: "Navigating the immigration process for different countries can be complex. Seeking professional guidance can help ensure a smooth transition."
                },
                {
                    heading: "Cultural Adjustment:",
                    text: "Adapting to a new culture and environment can be challenging. Researching the destination's customs and traditions can facilitate a smoother adjustment."
                }
            ]
        },
        {
            heading: "Conclusion:",
            text: "Overseas employment presents a vast and exciting prospect for Pakistani professionals. By focusing on skill development, acquiring relevant language skills, and researching opportunities, Pakistani workers can leverage the expanding scope of international employment and build successful careers on a global stage."
        }
    ]
}
